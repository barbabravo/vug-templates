...
import qbsPage 	 from './[page_name].vue';
import {qMenu} from 'qbs-components';


import qbsMenu 	from './[base_url]/components/menu.vue';


$(function(){	
	utils.extend({
	  api_user_currentlogin: {
	    url: '/api/user/currentlogin?ajaxID=5768fd04b461d2741728eb07'
	  }
	});
	// 获取登录信息
